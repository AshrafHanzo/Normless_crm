// Lightweight stroke icon set (lucide-style). Usage: <Icon name="dashboard" />
const ICONS = {
  ...
  palette: <><circle cx="13.5" cy="6.5" r=".5" /><circle cx="17.5" cy="10.5" r=".5" /><circle cx="8.5" cy="7.5" r=".5" /><circle cx="6.5" cy="12.5" r=".5" /><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.999 6.012 17.505 2 12 2z" /></>,
  ...
  note: <><path d="M4 4a2 2 0 0 1 2-2h8l6 6v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2Z" /><polyline points="14 2 14 8 20 8" /><line x1="8" y1="12" x2="15" y2="12" /><line x1="8" y1="16" x2="12" y2="16" /></>,
