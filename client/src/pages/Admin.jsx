...
const buildPerms = (f) => {
  ...
  return {
    ...
    inventory: !!(f.normless && f.inventory), inventory_edit: !!(f.normless && f.inventory && f.inventory_edit),
