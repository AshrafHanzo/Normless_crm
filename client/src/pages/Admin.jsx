          ...
          {form.role === 'owner' ? (
            ...
            {form.normless && form.marketing && (
              <div className="access-card data-access-card">
                ...
                {/* The daily report shows ad spend and store revenue, so it is granted on its own. */}
                <label className="page-check" style={{ margin: '10px 0 0' }}>
                  <input type="checkbox" checked={!!form.marketing_reports} onChange={e => setF({ marketing_reports: e.target.checked })} />
